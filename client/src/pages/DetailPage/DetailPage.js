        ...
        <div className="detail">
                    ...
                    <div className="container">
                        ...
                        <div className="detail__controls">
                            ...
                            <div className="detail__back">
                                ...
                                >
                                    <span> <Icon
                                        className={"material-icons"}>arrow_forward</Icon></span> {history.length > 1 ? 'Назад' : 'Главная'}
                                </button>
                            </div>
            ...
            >
                <div>
                    {deletedData ?
                        <div>
                            Мед. пункт <strong>{data.name}</strong> удален!<br/> Через 5 секунд вы будете перенаправлены
                            на страницу "Таблица"
                        </div> :
                        <div>
