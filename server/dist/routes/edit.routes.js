...
// /api/edit/rate/add
router.post('/rate/add', [], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/rate/update', [], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const connection = initializeConnection(configDB);
        let date = new Date();
        date = date.getFullYear() + '-' + (date.getMonth() < 10 ? '0' + date.getMonth() : date.getMonth()) + '-' + date.getDate();
...
router.post('/rate/delete', [], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const connection = initializeConnection(configDB);
