...
export function getPointsLocalitiesOfDistrict(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            WHERE district_id = ?`;
                r = yield new Promise((resolve, reject) => {
...
export function setPointsLocalities(req, res, values, conditions) {
    return __awaiter(this, void 0, void 0, function* () {
        let query;
        let r;
        try {
            if (req.body.district_id) {
                ...
                for (let i = 0; i < rows.length; i++) {
                    ...
                    yield setPointsLocality(values, conditions, locality);
                }
            }
            else {
                console.log("cant find district is null");
...
function setPointsLocality(values, conditions, locality) {
    return __awaiter(this, void 0, void 0, function* () {
        const updateQuery = `
      ...
      `;
        ...
        points_locality.locality_id = ?) AS exist`, [locality.id], (error, results) => {
            if (error) {
